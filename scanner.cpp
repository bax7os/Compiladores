...
// Returns the input
string Scanner::getInputString() { return this->input; }

// Returns the current position
int Scanner::getPos() { return this->pos; }

// Sets the current position
void Scanner::setPos(int pos) { this->pos = pos; }
...
int Scanner::getLine() { return this->line; }
...
Token *Scanner::nextToken() {
  ...
  while (true) {
    ...
    // If we have reached here, it means that the current character is not a
    // space, a tab, a new line or a comment
    break;
  }
  ...
  if (isalpha(currentChar)) {
    ...
    // Reserved words
    if (lexeme == "class" || lexeme == "public" || lexeme == "static" ||
        lexeme == "void" || lexeme == "main" || lexeme == "return" ||
        lexeme == "int" || lexeme == "boolean" || lexeme == "if" ||
        lexeme == "else" || lexeme == "while" || lexeme == "true" ||
        lexeme == "false" || lexeme == "new" || lexeme == "this" ||
        lexeme == "String" || lexeme == "extends") {
